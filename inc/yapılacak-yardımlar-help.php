...
<div class="help">
            <div class="imagebox">
              ...
              <div class="content">
                <h3><?php echo $yardim['yapılılacak_yardımlar_adres']?></h3>
                <p>
                 <?php echo $yardim['yapılılacak_yardımlar_text'];?>
                </p>
                <a href="<?php echo URL?>/yapılacak-yardımlar-detay.php?do=<?php echo $yardim['yapılılacak_yardımlar_id']?>">Detay</a>
              </div>
            </div>
          </div>
