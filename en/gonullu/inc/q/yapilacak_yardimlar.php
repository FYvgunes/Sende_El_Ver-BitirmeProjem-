...
<section class="section">
    <div class="section-inner">
        <h2 class="heading"><i class="fa fa-file-text-o"></i> Yapılacak Yardımlar<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=yapılacak_yardımlar-ekle"; ?>"><i class="fa fa-plus"></i> İçerik Ekle</a></small></h2>
        <div class="item row">
            <?php
            ...
            ?>
                <div class="list-group-item list-trend">
                    <div class="clearfix content-heading">
                        <img class="pull-left img-trend" src="<?php echo $content['yapılılacak_yardımlar_url']; ?>" />
                        <h3 class="txt-trend">Yapılacak Yardımlar <?php echo $content['yapılılacak_yardımlar_id']; ?> <br /><small><a target="_blank" href="<?php echo URL . "/en/" . $content['yapılılacak_yardımlar_url']; ?>"><i class="fa fa-eye"></i> Sayfayı Göster</a> | <a href="<?php echo URL . "/en/admin/index.php?do=yapılılacak_yardımlar-duzenle&id=" . $content['yapılılacak_yardımlar_id']; ?>"><i class="fa fa-edit"></i> Düzenle</a> | <a onclick="return confirm('İçeriği silmek istediğinizden emin misiniz?');" href="<?php echo URL . "/en/admin/index.php?do=yapılılacak_yardımlar-sil&id=" . $content['yapılılacak_yardımlar_id']; ?>"><i class="fa fa-trash-o"></i> Sil</a></small></h3>
                    </div>
                </div>
            <?php
            }
