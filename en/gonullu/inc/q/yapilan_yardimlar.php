...
<section class="section">
    <div class="section-inner">
        <h2 class="heading"><i class="fa fa-file-text-o"></i> Yapılan Yardımlar<br /></h2>
        <div class="item row">
            <?php
            ...
            ?>
                <div class="list-group-item list-trend">
                    <div class="clearfix content-heading">
                        ...
                        <h3 class="txt-trend">Yapılan Yardımlar <?php echo $content['yapılan_yardımlar_id']; ?> <br /><small><a  href="<?php echo URL . "/en/gonullu/index.php?do=yapılan_yardımlar-duzenle&id=" . $content['yapılan_yardımlar_id']; ?>"><i class="fa fa-eye"></i> Yardımı Göster</a></small></h3>
                    </div>
                </div>
            <?php
            }
