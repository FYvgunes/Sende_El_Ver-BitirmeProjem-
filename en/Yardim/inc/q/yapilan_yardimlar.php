...
<section class="section">
    <div class="section-inner">
        ...
        <div class="item row">
            ...
            $sorgu = $db->query("SELECT yapılan_yardımlar_id FROM yapılan_yardımlar WHERE yapılan_yardımlar_p=0 And yardimci_id='{$yardim_id}' ", PDO::FETCH_ASSOC);
            ...
            $row = $db->query("SELECT * FROM yapılan_yardımlar   WHERE  yardimci_id='{$yardim_id}'  ORDER BY yapılan_yardımlar_id DESC  LIMIT $baslangic, $limit", PDO::FETCH_ASSOC);
