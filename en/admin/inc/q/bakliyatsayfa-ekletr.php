...
if ($_POST) {
    ...
    if ($_FILES["resim1"]['name']) {
        ...
        if (move_uploaded_file($_FILES["$posted"]['tmp_name'], "resimler/" . $yeniad)) {
            $insert = $db->exec("INSERT INTO bakliyatsaydatr SET  bakliyat_url='{$hedef1}', bakliyat_title='{$Konala_title}', bakliyat_text='{$Konala_text}'");
            //$insert->execute();
            echo "<p class='alert alert-success'>İçerik başarıyla eklendi. Lütfen Bekleyiniz...</p>";
            header("Refresh: 0; url=" . URL . "/en/admin/index.php?do=bakliyatsayfatr");
        } else {
...
<section class="section">
    <div class="section-inner">
        ...
        <h2 class="heading"><i class="fa fa-plus"></i> Bakliyat Sayfa TR<br /><small><a href="<?php echo URL . "/en/admin/index.php?do=bakliyatsaydatr"; ?>"><i class="fa fa-file-text-o"></i> İçerikleri Göster </a></small></h2>
