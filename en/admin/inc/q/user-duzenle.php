...
if ($_POST) {
    ...
    { $insert = $db->exec("UPDATE  user   SET user_username ='{$yardım_username}', user_email= '{$yardım_email}', user_sifre= '{$yardım_sifre}' WHERE user_id={$id}");
